const data: Record<TProductId, TProduct> = {
  '6trfgkkj': {
    name: "Assassin's Creed_Valhalla",
    id: '6trfgkkj',
    sku: 'AX4M8SJV',
    price: 1.21,
    image: "/images/Assassin's Creed_Valhalla.jpg",
    attributes: {
      description:
  ...
  b8uthe2y: {
    ...
    sku: 'RMRCZN7E',
    price: 1.39,
    image: '/images/dragon ball z kakarot.jpg',
    attributes: {
      description:
  ...
  t345w48y: {
    ...
    sku: 'MW79ZZ6Y',
    price: 1.25,
    image: '/images/naruto to boruto shinobi striker.jpg',
    attributes: {
      description:
  ...
  h8gd9w16: {
    ...
    sku: 'FFRG78R9',
    price: 1.25,
    image: '/images/call of duty world at war.jpg',
    attributes: {
      description:
        'The Zutano avocado is a cold hardy, consistent producing avocado variety. It resembles the Fuerte in appearance but is less flavorful but more cold hardy. The green fruits are obovate in shape with waxy bumps on the skin. The flesh has a low oil but high water content which causes it to have a more fibrous texture.',
      shape: 'Pear',
  ...
  rt48l8iu: {
    ...
    sku: 'SSX98B7J',
    price: 1.25,
    image: '/images/Scarlet Nexus Deluxe Edition.jpg',
    attributes: {
      description:
        'The Zutano avocado is a cold hardy, consistent producing avocado variety. It resembles the Fuerte in appearance but is less flavorful but more cold hardy. The green fruits are obovate in shape with waxy bumps on the skin. The flesh has a low oil but high water content which causes it to have a more fibrous texture.',
      shape: 'Pear',
  ...
  yju78hy9: {
    ...
    sku: 'GHH7YU8R',
    price: 1.25,
    image: '/images/battlefield-v-deluxe-edition.jpg',
    attributes: {
      description:
        'The Zutano avocado is a cold hardy, consistent producing avocado variety. It resembles the Fuerte in appearance but is less flavorful but more cold hardy. The green fruits are obovate in shape with waxy bumps on the skin. The flesh has a low oil but high water content which causes it to have a more fibrous texture.',
      shape: 'Pear',
